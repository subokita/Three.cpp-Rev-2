...
namespace three {
    ...
    /**
     * Initialize deferred renderer, it does several things including:
     ...
     */
    void DeferredRenderer::init( string window_title, GLuint window_width, GLuint window_height ) {
